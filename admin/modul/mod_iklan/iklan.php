  ...
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
	...
	<!-- /TinyMCE -->
		...
		<?php 
			...
			$tentang = mysql_query("SELECT * FROM modul WHERE id_modul='2'");
		...
		<!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Halaman Pasang Iklan </small></h1>
                    </div>
					
					<div class="col-lg-12">
						<div class="panel panel-default">
							<form role='form' method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=iklan&act=update'>
							<input type='hidden' name='id' value='<?php echo"$w[id_modul]" ?>'>
								<div class="form-group">
									<label>Pasang Iklan</label>

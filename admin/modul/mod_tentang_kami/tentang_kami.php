 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
	...
	<!-- /TinyMCE -->
		...
		<?php 
			$aksi="modul/mod_tentang_kami/aksi_tentang_kami.php";
			$tentang = mysql_query("SELECT * FROM modul WHERE id_modul='4'");
		...
		<!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Halaman Tentang Kami </small></h1>
                    </div>
					
					<div class="col-lg-12">
						<div class="panel panel-default">
							<form role='form' method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=tentang_kami&act=update'>

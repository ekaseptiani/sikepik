...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
		...
		<?php
		$aksi="modul/mod_rental/aksi_rental.php";
		switch($_GET[act]){
			default:
		?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								Daftar Rental
								<button type="button" class="btn btn-default pull-right tambah" onclick="location.href='?module=rental&act=insertnew'">Tambah Data</button>
							</div>
							<!-- /.panel-heading -->
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
											...
											<?php 	
												$no=1;
												$rental = mysql_query("SELECT * FROM rental ORDER BY id_rental DESC");
												while($m=mysql_fetch_array($rental)){
												
												
												?>
												<tr>  
													<td><?php echo"$no" ?></td> 
													<td><img width="100px" src="../webmage/rental/<?php echo"$m[gambar]" ?>"></td> 
													<td><?php echo"$m[judul]" ?></td>
													<td><?php echo"$m[perhari]" ?></td>
													<td><?php echo"$m[status]" ?></td>
													
													<td class="center">
														<a href="<?php echo"?module=rental&act=edit&id=$m[id_rental]";?>">
														<button type="button" class="btn btn-primary">Edit</button></a>
														
														<a href="<?php echo"$aksi?module=rental&act=hapus&id=$m[id_rental]";?>" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><button type="button" class="btn btn-primary">Hapus</button></a>
														
														<a href="<?php echo"?module=galeri_rental&id=$m[id_rental]";?>"><button type="button" class="btn btn-primary">Galeri</button></a>
													</td> 
												</tr> 
											<?php $no++; } ?>
				...
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="panel panel-default col-lg-12">
							<form role="form" method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=rental&act=insertnew'>
								<div class="col-lg-6">
									...
									<div class="form-group">
										<label>Perhari</label>
										<input class="form-control" name="perhari" type="text">
									</div>
								...
								<div class="col-lg-12">
									...
									<div class="form-group">
										<label>Route</label>
										<textarea class="isi form-control" name="route" rows="12" type="text"></textarea>
									</div>
		...
		<?php break; 
			case"edit":
				$rental = mysql_query("SELECT * FROM rental WHERE id_rental='$_GET[id]'");
				$r=mysql_fetch_array($rental);
		?>
		<?php
			switch($_GET[act2]){
				default:
		?>
                ...
                <div class="row">
					...
					<div class="col-lg-12">
						<div class="panel panel-default col-lg-12">
							<form role="form" method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=rental&act=update'>
								<input type='hidden' name='id' value='<?php echo"$r[id_rental]" ?>'>
								...
								<div class="col-lg-6">
									...
									<div class="form-group">
										<label>Perhari</label>
										<input class="form-control" name="perhari" type="text" value="<?php echo"$r[perhari]" ?>">
									</div>
										...
										<?php
											$fasilitas=mysql_query("SELECT * FROM fasilitas ORDER BY nama ASC");
												while($f=mysql_fetch_array($fasilitas)){
													...
													$subfasilitas=mysql_query("SELECT * FROM subfasilitas WHERE id_rental ='$_GET[id]' AND id_fasilitas='$f[id_fasilitas]'");
								...
								<div class="col-lg-12">
									...
									<div class="form-group">
										<label>Route</label>
										<textarea class="isi form-control" name="route" rows="12" type="text"><?php echo"$r[route]" ?></textarea>
									</div>
									...
									<div class="form-group">
										<img width="270px" src="../webmage/rental/<?php echo"$r[gambar]" ?>">
									</div>

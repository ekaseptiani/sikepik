...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
		...
		<?php
		$aksi="modul/mod_bawal/aksi_bawal.php";
		switch($_GET[act]){
			default:
		?>
										...
										<tbody>
											...
											<?php 	
												...
												<tr>  
													...
													<td class="center">
														<a href="<?php echo"?module=bawal&act=edit&id=$m[id_kecamatan]";?>">
														<button type="button" class="btn btn-primary">Edit</button></a>
														
														<a href="<?php echo"$aksi?module=bawal&act=hapus&id=$m[id_kecamatan]";?>" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><button type="button" class="btn btn-primary">Hapus</button></a>
													</td> 
												</tr> 
											<?php $no++; } ?>
